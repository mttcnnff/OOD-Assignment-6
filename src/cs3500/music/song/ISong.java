...
/**
 * Interface for the functionality a song must offer.
 */
public interface ISong {
  ...
  /**
   * Combines this song's song with given song by "overlaying" it from the start.
   * Notes of the same beat, tone, octave, and instrument will be combined according to which one
   * is longer.
   *
   * @param song song you wish to combine with current one in your song.
   */
  void combine(ISong song);

  /**
   * Concatenates this song's song with the given song by appending it to the end.
   *
   * @param song song you wish to concatenate with current one in your song.
   */
