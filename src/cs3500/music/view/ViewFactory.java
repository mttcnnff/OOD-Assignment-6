...
public class ViewFactory {
   ...
   * @param type type of view to be made from three viable options:
   *             1. "console" - makes a console view of song.
   *             2. "visual" - makes a GUI view of the song.
   *             3. "midi" - plays song through through midi.
   ...
   * options.
   */
  public static IView makeView(String type, IPlayerModel model) throws IllegalArgumentException{
